...
/**
 * This is the main source for the Wi-Fi Pi survey application.
 * This executable can be used to provide network service as a daemon.
 * Here is the standard way to run this daemon:
 * wscand -i wlan0 -e -v 4 -p 100000 -o wscand.log
 */
