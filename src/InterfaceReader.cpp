...
static const char* MODULE_NAME = "InterfaceReader";
...
void *
MonitorInterface(void* context) {
    InterfaceReader reader(reinterpret_cast<ApplicationContext*>(context));
...
InterfaceReader::Run() {
  ...
  pcap_t* descr = pcap_open_live(this->GetContext()->dev, BUFSIZ, 1, 1000,
                                 errbuf);
